        ...
        <View contentContainerStyle={styles.containerHome}>
          <View style={styles.logo}>
            <Text style={styles.logo1}>
              Pet<Text style={styles.logo2}>Space</Text>
            </Text>
            <Menu
              color="#000"
              size={24}
          ...
          <View style={styles.box}>
            ...
            <View>
              <TextInput
                onBlur={() =>
                  setEstado(nome ? styles.estado : styles.estadoBlur)
                }
                style={estado}
              ...
              />
              {mostraErro ? (
                <Incorreto text={"Insira o nome do seu pet!"} />
              ) : null}
            </View>
            ...
            <View>
              ...
              />
              {mostraErro2 ? (
                <Incorreto text={"Escolha a raça do seu pet!"} />
              ) : null}
            </View>

            <Botao
              estilo={styles.botaoRoxo}
              estiloTxt={styles.txtBotaoRoxo}
              funcao={() => salvarPet()}
            ...
            onPress={() => navigation.replace("agendar")}>
              <Text style={{color: '#8C52FF', fontSize: 20}}>Voltar</Text>
            </TouchableOpacity>

            {/* <Botao
              estilo={styles.botaoBranco}
              estiloTxt={styles.txtBotaoBranco}
              funcao={() => navigation.replace("agendar")}
              textoBotao={"Voltar"}
            /> */}
          </View>
